    ...
    <footer className='bg-white py-12 md:py-16 border-t border-gray-200 mt-12'>
      <LayoutContainer>
            ...
            <ul className='space-y-2'>
              <li>
                <button
                  ...
                  className='text-gray-600 hover:text-red-700 text-sm cursor-pointer bg-transparent border-none p-0 text-left'
                >
                  My Account
                </button>
              </li>
        ...
        <div className='text-center pt-9 border-t border-gray-200'>
          <img src='/images/OfficialLogoPage/logo-ecommerce.png' alt='HypeMode Logo' className='h-15 mx-auto' />
